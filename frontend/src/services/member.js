 ...
 */
export const createVipOrder = (planId) =>
  api.post('/vip/orders', { planId, paymentMethod: 'ALIPAY' })

/**
 * 查询订单支付状态（前端轮询）
 * @param {string} orderNo
 */
export const queryVipOrderStatus = (orderNo) =>
  api.get(`/vip/orders/${orderNo}/status`)
